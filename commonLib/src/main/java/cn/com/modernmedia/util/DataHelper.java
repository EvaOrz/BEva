...
public class DataHelper {
     ...
     * @return
     */
    public static String getShowZhannei(Context context, String key) {
        return getPref(context).getString(key+"zhannei", "");
    }

    /**
     * @param context
     */
    public static void setShowZhannei(Context context, String key, String value) {
        String jsonS = getPref(context).getString(key+"zhannei", "");
        if (TextUtils.isEmpty(jsonS)) jsonS += value;
        else jsonS += "," + value;
        Editor editor = getPref(context).edit();
        editor.putString(key+"zhannei", jsonS);
        editor.commit();
    }
    ...
    public static int getFontSize(Context context) {
        return getPref(context).getInt(FONT_SIZE, (ConstData.getInitialAppId() == 20 || ConstData.getInitialAppId() == 1) ? 3 : 1);
    }
     ...
     * @param time
     */
    public static void setColumnUpdateTime(Context context, long time, int issueId) {
        Editor editor = getPref(context).edit();
     ...
     * @param time
     */
    public static void setArticleUpdateTime(Context context, long time, int issueId) {
        Editor editor = getPref(context).edit();
     ...
     * @param catId
     */
    public static void setIndexUpdateTime(Context context, String time, int catId) {
        Editor editor = getPref(context).edit();
     ...
     *
     * @param context
     * @param status  true:开启；otherwise:关闭
     */
    ...
    public static String getLastIssuePublishTime(Context context, String tagName) {
        return getPref(context).getString(LAST_ISSUE_PUBLISH_TIME + tagName, "");
    }
     ...
     * @param context
     */
    public static void setLastIssuePublishTime(Context context, String tagName, String publishTime) {
        Editor editor = getPref(context).edit();
