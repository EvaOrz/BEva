...
ConstData {
     ...
     * 版本号
     **/
    public static final int VERSION = 450;
    /**
     * splash停留时间
     **/
    ...
    public static String DEFAULT_PDF_PATH;
     ...
     * 设置应用id以及debug环境
     *
     * @param appId 1.商周；2.优家
     */
    public static void setAppId(int appId, int debug) {
        if (appId != -1) setAppId(appId);
        if (debug != -1) setDebug(debug);
        initDefaultValue();
    ...
    private static void initDefaultValue() {
        ...
        SlateApplication.DEFAULT_VIDEO_PATH = "/" + fileName + "/videos/";
