...
public class CaptureActivity extends Activity implements Callback {
    ...
    protected void doPickPhotoFromGallery() {
        try {
            ...
            Toast.makeText(this, R.string.no_photo,
        ...
        if (requestCode == PHOTO_PICKED_WITH_DATA) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (result == null) {
                        Looper.prepare();
                        Toast.makeText(CaptureActivity.this, R.string.no_qrcode, Toast.LENGTH_SHORT)
                                .show();
                        Looper.loop();
                    } else {
                        //浏览器跳转
                        ...
                        item.setSlateLink(result.toString());
...
//                scanBitmap.getWidth(),scanBitmap.getHeight(),0,0,scanBitmap.getWidth(),scanBitmap.getHeight());
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(result.toString()) && result.equals("") && result.toString().length() < 1) {
            ...
            ArticleItem item = new ArticleItem();
            item.setSlateLink(result.toString());
            UriParse.clickSlate(this, new ArticleItem[]{item});
