...
public abstract class FetchShiyeIndexHelper {
    ...
    public void getShiyeTagIndex(FetchApiType apiType) {
        ...
        OperateController.getInstance(mContext).getTagIndex(tagInfo, "", "", null, apiType, new FetchEntryListener() {
    ...
    public abstract void doAfterFecthShiye(TagArticleList articleList, boolean success);
}
