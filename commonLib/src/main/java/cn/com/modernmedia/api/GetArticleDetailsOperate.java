...
public class GetArticleDetailsOperate extends BaseOperate {
    ...
    public GetArticleDetailsOperate(int articleId, boolean isHtml) {
    ...
    protected String getUrl() {
        if (isHtml) {
            return UrlMaker.getArticleHtmlTxt(articleId + "");
        } else {
    ...
    private void parseArticleItem(JSONObject obj) {
        ...
        item.setHtml(obj.optString("html"));
