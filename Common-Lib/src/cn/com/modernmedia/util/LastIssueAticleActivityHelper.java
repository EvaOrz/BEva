...
public class LastIssueAticleActivityHelper {
	...
	public LastIssueAticleActivityHelper(Context mContext,
	...
	public void doGetLastIssueAricles() {
		if (transferArticle == null || getActivity() == null)
			return;
	...
	private void getLastIssueCats() {
		...
		OperateController.getInstance(mContext).getLastIssueCats(
