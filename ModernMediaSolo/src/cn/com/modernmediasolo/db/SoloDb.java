...
public class SoloDb extends SQLiteOpenHelper {
	...
	private static final String DATABASE_NAME = "solo.db";
	private static final int DATABASE_VERSION = 1;
	public static final String TABLE_NAME = "solo";
	// column name
			...
			cursor = db.query(
					...
					PARENTID
							...
							+ SoloHelper.checkSelection(fromOffset, toOffset,
									OFFSET, false), null, null, null, OFFSET
							+ " desc", limit ? LIMIT : null);// limit
