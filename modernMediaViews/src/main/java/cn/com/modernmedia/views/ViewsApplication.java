...
public class ViewsApplication extends CommonApplication {
    ...
    public static void addListener(String name, NotifyLastestChangeListener lastestChangeListener) {
