...
public class IndexViewPager extends CircularViewPager<TagInfo> implements
	...
	private void setTitle(int position) {
		if (ParseUtil.listNotNull(catItems) && catItems.size() > position) {
			...
			if (((CommonMainActivity) mContext).getIndexView() != null
					&& ((CommonMainActivity) mContext).getIndexView() instanceof IndexView)
				((IndexView) ((CommonMainActivity) mContext).getIndexView())
						.setTopMenuSelect(item);
		}
	}
