...
public class NewFavView extends BaseView implements FetchEntryListener {
    ...
    private void init() {
        ...
        addView(LayoutInflater.from(mContext).inflate(R.layout.fav_view, null), lp);
    ...
    private void initRes() {
        ...
        View view = xmlParse.inflate(template.getNavBar().getData(), null, null);
    ...
    public void setData(Entry entry) {
        adapter.clear();
        List<ArticleItem> list = NewFavDb.getInstance(mContext).getUserFav(Tools.getUid(mContext));
