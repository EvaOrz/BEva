...
public class IndexHeadPagerAdapter extends MyPagerAdapter<ArticleItem> {
	...
	public Object instantiateItem(ViewGroup container, final int position) {
		if (ConstData.getAppId() == 20)
			WeeklyLogEvent.logAndroidColumnHeadviewShowCount(context);
	...
	public void setPrimaryItem(ViewGroup container, int loopPosition,
		...
		if (object instanceof View
				&& ((View) object).getTag(R.id.focus_article) instanceof XMLParse) {
			XMLParse parse = (XMLParse) ((View) object)
					.getTag(R.id.focus_article);
