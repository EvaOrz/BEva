...
public class SlateApplication extends Application {
	 ...
	 * youthMba 108; zhihuiyun:110;wezeit:105
	 **/
	...
	private void parseConfiguration() {
		...
		try {
			...
			mConfig.setHas_weixin(ParseUtil.getIntValue(rootDic, "has_weixin",
					1));
			...
			mConfig.setHas_single_view(ParseUtil.getIntValue(rootDic,
					"has_single_view", 0));
			mConfig.setFlurry_api_key(ParseUtil.getStringValue(rootDic,
					"flurry_api_key", ""));
			mConfig.setParse_app_id(ParseUtil.getStringValue(rootDic,
					"parse_app_id", ""));
			mConfig.setParse_client_id(ParseUtil.getStringValue(rootDic,
					"parse_client_id", ""));
			mConfig.setWeixin_app_id(ParseUtil.getStringValue(rootDic,
					"weixin_app_id", ""));
			mConfig.setWeixin_app_secret(ParseUtil.getStringValue(rootDic,
					"weixin_app_secret", ""));
			mConfig.setWeixin_partner_id(ParseUtil.getStringValue(rootDic,
					"weixin_partner_id", ""));
			mConfig.setWeixin_app_id_google(ParseUtil.getStringValue(rootDic,
					"weixin_app_id_google", ""));
			mConfig.setWeibo_app_id(ParseUtil.getStringValue(rootDic,
					"weibo_app_id", ""));
			mConfig.setWeibo_app_id_goole(ParseUtil.getStringValue(rootDic,
					"weibo_app_id_goole", ""));
			mConfig.setQq_app_id(ParseUtil.getStringValue(rootDic, "qq_app_id",
					""));
			mConfig.setCache_file_name(ParseUtil.getStringValue(rootDic,
					"cache_file_name", ""));
			mConfig.setTemplate_version(ParseUtil.getIntValue(rootDic,
					"template_version", 1));
			mConfig.setHas_subscribe(ParseUtil.getIntValue(rootDic,
					"has_subscribe", 0));
			...
			mConfig.setWeixin_public_number(ParseUtil.getStringValue(rootDic,
