 ...
 * @author jiancong
 */
public class ModifyEmailActivity extends SlateBaseActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.modify_email_button_back) {
            ...
            if (UserTools.checkString(email, mEmailEdit, shakeAnim) && UserTools.checkString(password, mPwdEdit, shakeAnim))
    ...
    private void doModifyEmail(final String email, String password) {
        ...
        UserOperateController.getInstance(this).modifyUserInfo(user.getUid(), user.getToken(), user.getUserName(), user.getNickName(), "", user.getPassword(), user.getDesc(), false, new UserFetchEntryListener() {
            ...
            public void setData(final Entry entry) {
                ...
                if (entry instanceof User) {
                    ...
                    if (error.getNo() == 0) {
                        ...
                        // 更新本地存储的用户名
                        SlateDataHelper.saveUserName(ModifyEmailActivity.this, email);
                        // 跳转到金币页面
                ...
                UserTools.showDialogMsg(ModifyEmailActivity.this, "", TextUtils.isEmpty(msg) ? getString(R.string.msg_modify_email_failed) : msg);
            }
        });
    }
