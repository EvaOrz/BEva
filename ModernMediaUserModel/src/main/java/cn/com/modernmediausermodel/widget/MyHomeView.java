...
public class MyHomeView implements OnClickListener, CardViewListener {
    ...
    private void initWidget() {
        view = LayoutInflater.from(mContext).inflate(R.layout.activity_square, null);
        titleBar = view.findViewById(R.id.square_bar_layout);
        tipText = (TextView) view.findViewById(R.id.square_no_tip);
        listView = (CheckFooterListView) view.findViewById(R.id.square_list_view);
        ...
        ((TextView) view.findViewById(R.id.square_bar_title)).setText(R.string.my_homepage);
        init();
    }
    ...
    private void init() {
        ...
        cardListHelp = new BaseCardListView(mContext, listView) {
            ...
            @Override
            public void afterGetCardList(Entry entry, String timelineId, boolean isGetMore, boolean isPull) {
                super.afterGetCardList(entry, timelineId, isGetMore, isPull);
            }
        };
