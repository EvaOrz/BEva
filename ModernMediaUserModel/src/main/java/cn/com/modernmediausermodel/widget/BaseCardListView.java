...
public abstract class BaseCardListView {
     ...
     * 初始化listview
     *
     * @param isForUser 是否用户资料页
     * @param head      headview，后加
     */
     ...
     * @param isGetMore
     */
    public void afterGetCardList(Entry entry, String timelineId,
    ...
    //本地搜索成功！！！
    public boolean getSearch(String se) {
        mCard = RecommendCardDb.getInstance(mContext).getSearchCard(se);
        Users users = userInfoDb.getUsersInfo();
        mCard.setUserInfoMap(users.getUserInfoMap());
