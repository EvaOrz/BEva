...
public class UrlMaker {
	...
	public static void setUserModelUrl() {
		...
		if (UserConstData.IS_DEBUG == 0) {// 线上环境
			...
			// "http://develop.cname.bbwc.cn/mmuser/interface/index.php";
	...
	public static String getVerifyCode() {
		return USER_MODEL_URL + "?m=sms&a=send&datatype="
				+ UserConstData.DATA_TYPE;
	}
	...
	public static String getBandStatus() {
		return USER_MODEL_URL + "?m=user&a=bindstatus&datatype="
				+ UserConstData.DATA_TYPE;
	}
	...
	public static String bandAccount() {
		return USER_MODEL_URL + "?m=user&a=bind&datatype="
				+ UserConstData.DATA_TYPE;
	}
	...
	public static String getActiveList(String uid, String token) {
		return USER_MODEL_URL + "?m=active&r=service/list/datatype/"
