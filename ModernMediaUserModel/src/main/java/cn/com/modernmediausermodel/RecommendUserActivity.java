 ...
 * @author user
 */
public class RecommendUserActivity extends SlateBaseActivity implements OnClickListener {
    ...
    private void initDataFromBundle() {
        ...
        if (getIntent().getExtras() != null) {
            ...
            if (bundle.getSerializable(UserPageTransfer.USER_KEY) instanceof User) {
                mUser = (User) bundle.getSerializable(UserPageTransfer.USER_KEY);
            }
        }
     ...
     */
    private void doBack() {
        if (userView.getAdapter().isHasModify() && mUser != null && mUser.getUid().equals(Tools.getUid(this)))
            setResult(RESULT_OK);
        finish();
    }
