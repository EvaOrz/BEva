...
public class UserCentManager {
	private static final String TYPE_LOGIN = "CentOpenApp"; // 登录
	private static final String TYPE_READ_ARTICLE = "CentReadNewArticle"; // 阅读文章
	private static final String TYPE_CREATE_CARD = "CentCreateNewCard"; // 写笔记
