 ...
 *
 */
public class GifViewParse extends BaseViewParse {

	public GifViewParse(Context context, XMLParse xmlParse) {
	 ...
	 * @return
	 */
	public View createGifView(XmlPullParser parser, View parent) {
		GifView gifImage = new GifView(mContext);
