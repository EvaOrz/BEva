...
public class TextViewParse extends BaseViewParse {
	...
	private void parseText(String atts, String value, TextView textView) {
		...
		} else if (atts.equalsIgnoreCase("title_default_font")) {
			textView.setTag(R.id.title_default_font, value);
		} else if (atts.equalsIgnoreCase("title_readed_font")) {
			textView.setTag(R.id.title_readed_font, value);
